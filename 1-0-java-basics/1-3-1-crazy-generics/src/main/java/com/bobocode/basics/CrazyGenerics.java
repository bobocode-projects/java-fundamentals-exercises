    ...
    static class CollectionUtil {
        ...
        public static <T extends BaseEntity> boolean hasDuplicates(List<T> entities, T targetEntity) {
            ...
            for (T entity : entities) {
                if (Objects.equals(entity.getUuid(), targetEntity.getUuid())) {
                    count++;
                    if (count > 1) {
                        return true;
                    }
        ...
        public static <T extends BaseEntity> T findMostRecentlyCreatedEntity(Collection<T> entities) {
            ...
            Comparator<T> createdOnComparator = Comparator.comparing(BaseEntity::getCreatedOn);
            Optional<T> maxEntity = findMax(entities, createdOnComparator);
